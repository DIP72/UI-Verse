...
function initLiveSandboxes() {
  document.querySelectorAll('.component-card').forEach((card, index) => {
    ...
    iframe.style.width = '100%'; iframe.style.minHeight = '160px'; iframe.style.border = '1px solid #e8ebf2'; iframe.style.borderRadius = '8px'; iframe.style.background = 'transparent'; iframe.setAttribute('title', 'Live component preview'); iframe.setAttribute('sandbox', 'allow-scripts');
    ...
    if (h3) h3.after(shell); else card.insertBefore(shell, card.firstChild);
